...
#ifndef PROTOBUF_INCLUDED_qos_5fprofile_2eproto
#define PROTOBUF_INCLUDED_qos_5fprofile_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_qos_5fprofile_2eproto 
...
class QosProfile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.cyber.proto.QosProfile) */ {
 public:
  ...
  inline QosProfile* New() const final {
    return CreateMaybeMessage<QosProfile>(NULL);
  }

  QosProfile* New(::google::protobuf::Arena* arena) const final {
 ...
 private:
  ...
  int reliability_;
  int durability_;
  friend struct ::protobuf_qos_5fprofile_2eproto::TableStruct;
};
// ===================================================================
...
#endif  // PROTOBUF_INCLUDED_qos_5fprofile_2eproto
